...
| `/sdd-release` | Prepare a production release handoff with checks, changelog review, version confirmation, release metadata, one normal source push, and the configured release PR; merge/deploy/tag/publish remain separately authorized. |
