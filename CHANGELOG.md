...
- Configuration and lifecycle commands now reject unknown keys, physical repository aliases, invalid repository-artifact overlap or escape, repository-only planning guesses, and active/closed Change ID collisions. Full owner-relative private planning-path confinement remains pending.
