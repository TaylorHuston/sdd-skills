...
| 2026-07-23 | S3/R2-S3 schema/runtime parity | independent security review; TDD | runtime config, checked schemas, CLI test, S3 Epic truth | A Windows-style leading separator is rejected consistently by runtime validation and the published schemas. | commit pending |
